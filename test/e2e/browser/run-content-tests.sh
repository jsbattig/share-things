...
# Run content sharing tests in the background and then run tests without waiting for user input
...
# Run the content sharing tests
echo "Running content sharing E2E browser tests..."
npx playwright test test/e2e/browser/tests/content-sharing.test.ts --config=test/e2e/browser/playwright.config.ts --project=chromium --reporter=list
